...
export const getAllMakes = (): string[] => {
  const regularMakes = Object.keys(constructionModels.regular);
  const electricMakes = Object.keys(constructionModels.electric || {});
  return [...new Set([...regularMakes, ...electricMakes])].sort();
};
